...
public class SpringConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("me.victor.data.entities");
...
//        dataSource.setPassword(DatabaseConfig.get("password"));
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/school?allowPublicKeyRetrieval=true&useSSL=false&createDatabaseIfNotExist=true");
